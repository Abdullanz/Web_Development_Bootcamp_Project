        ...
        Campground.findById(req.params.id)
            ...
            .exec(function(err, campground) {
                ...
                Review.create(req.body.review, function(err, review) {
                    ...
                    //save campground
                    campground.save();
                    req.flash("success", "تمت إضافة تقييمك بنجاح");
        ...
        function(err, updatedReview) {
            ...
            Campground.findById(req.params.id)
                ...
                .exec(function(err, campground) {
                    ...
                    //save changes
                    campground.save();
                    req.flash("success", "تم تعديل تقييمك بنجاح");
                    res.redirect("/campgrounds/" + campground._id);
                });
        }
    );
...
router.delete("/:review_id", middleware.checkReviewOwnership, function(
    ...
    Review.findByIdAndRemove(req.params.review_id, function(err) {
        ...
        Campground.findByIdAndUpdate(
                req.params.id, { $pull: { reviews: req.params.review_id } }, { new: true }
            )
            .populate("reviews")
            .exec(function(err, campground) {
                if (err) {
                ...
                //save changes
                campground.save();
                req.flash("success", "تم حذف تقييمك بنجاح");
